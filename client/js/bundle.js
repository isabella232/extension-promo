...
var Observable, googlerTemplate, model;
...
model = {
  ...
  type: function(text, n) {
    ...
    if (!(n >= text.length)) {
      this.value(text.substring(0, n + 1));
      n++;
...
},{"../templates/googler":7,"o_0":6}],3:[function(require,module,exports){
...
},{"../package.json":5,"o_0":4}],4:[function(require,module,exports){
(function (global){
