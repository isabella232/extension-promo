...
googler = require('./googler');

googler.init();


},{"./googler":2}],2:[function(require,module,exports){
var Observable, googlerTemplate, model, searchData;
...
model = {
  ...
  type: function(text, n) {
    ...
    if (n < text.length) {
      ...
      return setTimeout(((function(_this) {
        return function() {
          return _this.type(text, n);
        };
      })(this)), 100);
    } else {
      return setTimeout(((function(_this) {
        return function() {
          _this.state('highlight');
  ...
  relayout: function() {
    return setTimeout(((function(_this) {
      return function() {
        _this.state('relayout');
        _this.googleResults(searchData.googleResults);
        return _this.likeastoreResults(searchData.likeastoreResults);
      };
    })(this)), 200);
  }
};
...
},{"../templates/googler":8,"./searchData":3,"o_0":7}],3:[function(require,module,exports){
...
},{"../package.json":6,"o_0":5}],5:[function(require,module,exports){
(function (global){
...
module.exports={
  ...
  "_id": "hamlet-runtime@0.6.0-pre.21",
  "_shasum": "8cf5e3a78928a4cf4419e5e4c915f85469ee7178",
  "_from": "hamlet-runtime@^0.6.0-pre.11",
  "_resolved": "https://registry.npmjs.org/hamlet-runtime/-/hamlet-runtime-0.6.0-pre.21.tgz"
}
