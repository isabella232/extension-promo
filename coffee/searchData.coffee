# static results for interactive search

exports.googleResults = [
	{
		title: "Dodo - Wikipedia, the free encyclopedia"
		link: "en.wikipedia.org/wiki/Dodo"
		text: "The dodo (Raphus cucullatus) is an extinct flightless bird that was endemic to the island of Mauritius, east of Madagascar in the Indian Ocean. Its closest genetic ..."
	}
	{
		title: "Dodo: Cheap ADSL Broadband, NBN, Mobile & Home"
		link: "www.dodo.com/"
		text: "Get connected with Dodo, Australia's supplier of cheap ADSL broadband, NBN, mobile & home phone packages. Super fast connections & big downloads."
	}
	{
		title: "The Dodo : For the Love of Animals"
		link: "https://twitter.com/dodo"
